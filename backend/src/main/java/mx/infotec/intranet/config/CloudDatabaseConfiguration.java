package mx.infotec.intranet.config;
...
@Configuration
@EnableMongoRepositories("mx.infotec.intranet.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("mx.infotec.intranet.config.dbmigrations");
